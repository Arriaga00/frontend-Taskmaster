...
const CreateTask = () => {
  ...
  return (
    <div className="bottom-0 left-0 right-0 absolute w-[97%] flex  items-center mb-2 p-3  border border-[#242424] rounded-lg shadow-lg backdrop-blur-[4px] glass bg-[rgba(255,255,255,0)]">
      <form
